...
- For scaffolding, use template guidance from `spring-error-code-template.mdc`.
...
## Expected Outcome
- Reduced unhandled exceptions and null leaks.
- Reduced lazy loading and N+1 issues.
- Consistent, production-safe API behavior.
