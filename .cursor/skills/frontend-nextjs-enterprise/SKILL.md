...
- For access-control scaffolding, use `frontend-access-control-template.mdc`.
...
- For audit/review/refactor, use `frontend-react-anti-patterns-scale-fail.mdc` (100-rule checklist).
