...
public class RoleController {
    ...
    public ResponseEntity<Void> assignClaims(@PathVariable String id,
                                              @Valid @RequestBody AssignClaimsRequest request) {
    ...
    @PreAuthorize("@perm.has('role:assign_claim')")
    public ResponseEntity<Void> removeClaim(@PathVariable String id,
    ...
    public ResponseEntity<Void> assignPermissions(@PathVariable String id,
    ...
    @PreAuthorize("@perm.has('role:assign_permission')")
    public ResponseEntity<Void> removePermission(@PathVariable String id,
