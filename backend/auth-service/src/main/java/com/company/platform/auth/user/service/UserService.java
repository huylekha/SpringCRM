...
public class UserService {
    ...
    public AssignRolesResponse assignRoles(String userId, AssignRolesRequest request) {
        ...
        List<RoleSummary> summaries = user.getRoles().stream()
                .map(r -> RoleSummary.builder()
                        .id(r.getId()).roleCode(r.getRoleCode()).roleName(r.getRoleName()).build())
                .toList();
    ...
    private UserResponse toUserResponse(AuthUser u) {
        return UserResponse.builder()
                ...
                .fullName(u.getFullName()).status(u.getStatus())
                .createdAt(u.getCreatedAt()).createdBy(u.getCreatedBy())
                .build();
    }
    ...
    private UserDetailResponse toUserDetailResponse(AuthUser u) {
        ...
        return UserDetailResponse.builder()
                .id(u.getId()).username(u.getUsername()).email(u.getEmail())
                .fullName(u.getFullName()).status(u.getStatus())
                .roles(roles).lastLoginAt(u.getLastLoginAt())
                .createdAt(u.getCreatedAt()).createdBy(u.getCreatedBy())
                .updatedAt(u.getUpdatedAt()).updatedBy(u.getUpdatedBy())
                .build();
    }
