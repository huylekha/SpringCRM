...
class JwtTokenProviderTest {
    ...
    void generateAccessToken_validPayload_returnsToken() {
        String token = tokenProvider.generateAccessToken("user-123", List.of("SUPER_ADMIN"), List.of("admin_claim"));
    ...
    void getRolesFromToken_returnsRoles() {
        String token = tokenProvider.generateAccessToken("user-789", List.of("CRM_ADMIN", "AUDITOR"), List.of());
