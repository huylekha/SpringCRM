...
/**
 * JPA implementation of the domain OrderRepository. Adapts between domain interfaces and JPA
 * persistence.
 */
@Repository
...
public class JpaOrderRepository implements OrderRepository {
  ...
  public Optional<Order> findById(String id) {
    ...
    return jpaRepository.findByIdAndDeletedFalse(id).map(orderMapper::toDomainEntity);
  }
