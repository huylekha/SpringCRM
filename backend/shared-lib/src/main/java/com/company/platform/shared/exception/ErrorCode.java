...
public enum ErrorCode {
    ...
    VALIDATION_PASSWORD_COMPLEXITY("VALIDATION_405", "Password must contain uppercase, lowercase, number and special character"),
    ...
    VALIDATION_USERNAME_FORMAT("VALIDATION_408", "Username can only contain letters, numbers and underscores"),
