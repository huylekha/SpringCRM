...
public class MessageService {
     ...
     */
    @NonNull
    public String getMessage(@NonNull ErrorCode errorCode, @Nullable Object[] args, @NonNull Locale locale) {
        try {
            ...
            log.warn("No message found for code: {} in locale: {}, falling back to default message", 
                errorCode.getCode(), locale);
    ...
    public String getMessage(@NonNull String code, @Nullable Object[] args, @NonNull Locale locale) {
        try {
            ...
            log.warn("No message found for code: {} in locale: {}, returning code as fallback", 
                code, locale);
            return code;
        }
    }
