...
/**
 * Filter that generates or extracts trace ID for distributed tracing.
 * Trace ID is propagated via:
 * - MDC for automatic logging inclusion
 * - Response header for client consumption
 * - Request attribute for controller access
 */
@Slf4j
@Component
...
public class TraceIdFilter extends OncePerRequestFilter {
     ...
     * Supports both new (X-Trace-Id) and legacy (X-Correlation-Id) headers.
     */
    ...
    /**
     * Generate 16-character hex trace ID.
     * Format: lowercase hexadecimal, no hyphens
     */
